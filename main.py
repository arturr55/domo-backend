...
async def get_listings(
    ...
    if city:
        _city_aliases = {
            'Toshkent':      ['Toshkent', 'Ташкент', 'Tashkent', 'Toshkend'],
            'Samarqand':     ['Samarqand', 'Самарканд', 'Samarkand'],
            'Buxoro':        ['Buxoro', 'Бухара', 'Bukhara'],
            'Namangan':      ['Namangan', 'Наманган'],
            'Andijon':       ['Andijon', 'Андижан', 'Andijan', 'Andizhan'],
            "Farg'ona":      ["Farg'ona", 'Фергана', 'Fergana', 'Fargona', 'Farghona'],
            'Nukus':         ['Nukus', 'Нукус', "No'kis", 'Nokis'],
            'Qarshi':        ['Qarshi', 'Карши', 'Karshi'],
            "Qo'qon":        ["Qo'qon", 'Коканд', 'Kokand', 'Qoqon'],
            'Termiz':        ['Termiz', 'Термез', 'Termez'],
            'Navoiy':        ['Navoiy', 'Навои', 'Navoi'],
            'Jizzax':        ['Jizzax', 'Джизак', 'Jizzakh', 'Jizzak'],
            'Guliston':      ['Guliston', 'Гулистан', 'Gulistan'],
            'Chirchiq':      ['Chirchiq', 'Чирчик', 'Chirchik'],
            'Angren':        ['Angren', 'Ангрен'],
            'Olmaliq':       ['Olmaliq', 'Алмалык', 'Almalyk', 'Olmalik'],
            'Urganch':       ['Urganch', 'Ургенч', 'Urgench'],
            "Marg'ilon":     ["Marg'ilon", 'Маргилан', 'Margilan', 'Margilon'],
            'Shahrisabz':    ['Shahrisabz', 'Шахрисабз', 'Shakhrisabz'],
            "Kattaqo'rg'on": ["Kattaqo'rg'on", 'Каттакурган', 'Kattakurgan', 'Kattakorgon'],
            'Denov':         ['Denov', 'Денов'],
            'Yangiyer':      ['Yangiyer', 'Янгиер'],
            'Gazalkent':     ['Gazalkent', 'Газалкент'],
            'Zarafshon':     ['Zarafshon', 'Зарафшан', 'Zarafshan'],
            'Muborak':       ['Muborak', 'Мубарек', 'Mubarek'],
            'Kitob':         ['Kitob', 'Китоб'],
            'Kogon':         ['Kogon', 'Коган', 'Kagan'],
            "G'ijduvon":     ["G'ijduvon", 'Гиждуван', 'Gijduvan', 'Gijduvon'],
            ...
            'Санкт-Петербург': ['Санкт-Петербург', 'Saint-Petersburg', 'SPb', 'Питер'],
            'Алматы':        ['Алматы', 'Almaty'],
            'Астана':        ['Астана', 'Astana', 'Nursultan'],
